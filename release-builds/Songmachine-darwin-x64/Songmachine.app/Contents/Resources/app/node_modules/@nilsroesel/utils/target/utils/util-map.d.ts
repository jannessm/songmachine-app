export declare class UtilMap<K, V> extends Map<K, V> implements Mappable {
    ...
    static asES5<K, V>(...args: any[]): UtilMap<K, V>;
    /**
     ...
     */
    map<R>(supplier: (value: V, key?: K) => R): UtilMap<K, R>;
    /**
     ...
     */
    filter(predicate: (value: V, key?: K) => boolean): UtilMap<K, V>;
}
export interface Mappable {
    map<R>(supplier: () => R): any;
}
