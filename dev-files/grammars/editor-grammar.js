...
var grammar = {
    ...
    {"name": "br_r$subexpression$2", "symbols": [{"literal":"<"}, /[gG]/, {"literal":">"}], "postprocess": function(d) {return d.join(""); }},
    {"name": "br_r", "symbols": ["br_r$subexpression$2", "br_g"], "postprocess": pP.g},
    {"name": "br_r$subexpression$3", "symbols": [{"literal":"<"}, /[bB]/, {"literal":">"}], "postprocess": function(d) {return d.join(""); }},
    {"name": "br_r", "symbols": ["br_r$subexpression$3", "br_b"], "postprocess": pP.b},
